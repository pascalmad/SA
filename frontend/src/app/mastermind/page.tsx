                ...
                <div className="space-y-4">
                  ...
                  {gameState.isGameOver && (
                    <motion.div
                      ...
                      className={cn(
                        "p-6 rounded-md text-center font-bold text-white flex flex-col items-center",
                    ...
                    >
                      ...
                      <Button
                        variant="outline"
                        className="bg-white text-black hover:bg-gray-100 hover:text-black dark:hover:bg-gray-200 px-6 py-2"
                        onClick={resetGame}
                      >
                        Play Again
                      </Button>
